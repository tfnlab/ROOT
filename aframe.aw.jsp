...
<body >
    <a-scene  background="color: #004aad" capture-screenshot vr-mode-ui="enabled: false" light="defaultLightsEnabled: false">
      ...
      <a-entity id="rig" position="0 2 2" rotation="-20 0 0" spectator="true" >
