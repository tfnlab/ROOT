<%@ page language="java" import="java.lang.Thread,org.apache.commons.io.IOUtils,org.apache.commons.io.output.*,java.nio.charset.Charset,java.io.*,java.util.*,java.awt.image.BufferedImage,javax.imageio.ImageIO,java.io.OutputStream,java.io.FileInputStream,java.io.File"%><%
      ...
      String filename = "/var/lib/tomcat9/webapps/glb/funko" + request.getParameter("head") + "_" + request.getParameter("shi") + "_" + request.getParameter("m") + "_" + request.getParameter("eyes") + "_" + request.getParameter("ears") + "_" + request.getParameter("hp") + "_" + request.getParameter("sho") + "_" + request.getParameter("hb") + ".gltf";
