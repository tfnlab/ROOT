...
<body >
    <a-scene  background="color: white" vr-mode-ui="enabled: false" light="defaultLightsEnabled: false">
      ...
      <a-entity gltf-model="#cityModel" modify-materials position="0 0 0" rotation="0 45 0" ></a-entity>    <!-- "button" -->
      <a-entity id="rig" position="0 100 200" rotation="-45 0 0" spectator="true" >
