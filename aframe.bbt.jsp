...
<body >
    <a-scene background="color: black" capture-screenshot vr-mode-ui="enabled: false">
      <a-assets>
      ...
      <a-entity gltf-model="#cityModel" modify-materials rotation="35 0 0"></a-entity>    <!-- "button" -->
      <a-entity id="rig" position="0 60 250" rotation="-10 0 0" spectator="true" >
